const EsLangs = {
  ...
  'terms.paragraph_47.2':
    'Si cree que Startup Studio LLC no se ha adherido a los Términos, póngase en contacto con Startup Studio LLC enviándonos un correo electrónico a legal@joinstudioos.com . Haremos todo lo posible para abordar sus preocupaciones. Si considera que su queja ha sido resuelta de manera incompleta, le invitamos a que nos lo haga saber para una investigación posterior.',
  'terms.paragraph_48':
  ...
  'storyInMotion.guest_q&a_videos': 'Story in Motion Podcast Episodes',
  // SAVED page
