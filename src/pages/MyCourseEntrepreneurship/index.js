...
function MyCourseEntrepreneurship() {
  ...
  const handlePlayEntrepreneur = (index) => {
    if (playingVideoIndex === index) return
    pauseAllVideos()
    setTimeout(() => {
  ...
  const handlePlayKeyPoint = (index) => {
    if (playingKeyPointIndex === index) return
    pauseAllVideos()
    setTimeout(() => {
    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <div className='gradient-background-course'>
        <div className='welcome-journey-text'>
          ...
          <p>
            Throughout each module, you will engage in the levels of the LTS model to identify a problem worth solving and turn concept into execution as you build a product or service ready for market entry.
          </p>
        </div>
        ...
        <div className='col-md-12 general-video-container'>
            ...
            <div style={{ width: '100%' }}>
              <div className='responsive-video-first responsive-accordion'>
                <ReactPlayer
                  ...
                  playing={true}
                  preload='metadata'
                  light='https://d5tx03iw7t69i.cloudfront.net/Month_1/M1-Vid-1-Thumbnail.jpg'
                  config={{
                    file: {
          ...
          <div className="accordion accordion-flex" id="accordionExample">
            {[
              { title: 'Introducing the Entrepreneurs', type: 'entrepreneurs' },
              { title: 'Key Points That You’ll Learn', type: 'key_points' },
              { title: 'Three Levels of Your Journey', type: 'levels_of_journey' },
            ].map((data, index) => (
              <div style={{ marginRight: '-10px' }} key={index}>
                <h2 className="accordion-header accordion-content-section-header" id={`heading-${index}`}>
                  <button
                    className={`accordion-button ${activeAccordion === index ? 'active-accordion' : 'collapsed'} accordion-outter button-accordion`}
                    type="button"
                ...
                <div
                  ...
                  className={`accordion-collapse accordion-content-section collapse ${activeAccordion === index ? 'show' : ''}`}
                      ...
                      <div className="levels-of-journey">
                        <div className='levels-of-journey__level'>
                          ...
                          <div className='levels-of-journey__description'>
                            Entrepreneurship is a mindset, and in the first level of this program,  
                            you will engage in developing this mindset as your preparation for starting 
                            your journey on the pathway to entrepreneurship.
                            You need proof of yourself as an entrepreneur and through this 
                            program you will create content that can publicly speak to your values, 
                            your purpose, your mindset, and your skillset.The first step in creating 
                            this proof is developing content that solidifies your statement of "I Am.".
                            Who are you and how do you want the world to see you? It's time for you to 
                            communicate you professional identity.
                          </div>
                        </div>
                        <div className='levels-of-journey__level'>
                          <p className='levels-of-journey__title'>
                            <span>LEVEL 2 |</span> Understanding Learn to Start
                          </p>
                          <div className='levels-of-journey__description'>
                            In the second level, you will immerse yourself in the LTS model. 
                            People want to work with people they like, respect, and trust. 
                            So, you will begin the LTS process by building yourself first. 
                            With your digital “I Am” video ready to introduce you to your 
                            cohort and the world, it is time to assess your experiences and 
                            mindset so far by evaluating yourself according to the LTS model 
                            and vet potential partners, thus creating a foundation for a 
                            successful startup.
                          </div>
                        </div>
                        <div className='levels-of-journey__level'>
                          ...
                          <div className='levels-of-journey__description'>
                            ...
                            opportunities for collaboration, you can move on to creating the startup, 
                            itself. You’re going to be using your own personal experiences and 
                            passions to find a problem worth solving and begin to construct 
                            the framework of your startup. You’ll engage in industry and 
                            market analysis, develop a brand, build a business plan, 
                            create a financial framework, and evaluate the sustainability, 
        ...
        >
          <Modal.Body>
            <div className='alert-modal__text'>
              Would you like to skip this page in the future and go directly to the course?
            </div>
            <div className='alert-modal__buttons'>
              <a href='#' onClick={goToJournal(true)} className='button'>YES, PLEASE!</a>
              <a href='#' onClick={goToJournal()} className='button-naked'>NOT RIGHT NOW</a>
            </div>
          </Modal.Body>
        </Modal>
      </div>
