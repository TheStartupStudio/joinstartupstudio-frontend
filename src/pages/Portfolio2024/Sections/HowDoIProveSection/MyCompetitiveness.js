...
function MyCompetitiveness(props) {
  ...
  useEffect(() => {
    if (props.data) setMyCompetitiveness([...props.data, { category: 'my-competitiveness', isAddBox: true }])
  }, [props.data])
  ...
  return (
    <div className={'container'}>
      {myCompetitiveness?.length === 1 && myCompetitiveness[0].isAddBox  && !isEditSection ? (
        <NoDataDisplay
          src={mentorsImage}
          text={
