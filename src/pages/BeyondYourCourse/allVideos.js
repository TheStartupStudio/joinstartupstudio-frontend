  ...
  useEffect(() => {
    switch(activeLevel) {
      ...
      case 2: // Story in Motion Podcast Episodes
        setPageTitle('Studio Guidance | STORY IN MOTION PODCAST EPISODES')
              ...
              >
                <div style={{margin:'0 1rem'}}>
                  <div style={{marginBottom:'2rem'}}>
                    <Link to='/beyond-your-course' style={{color:'#000000'}}>Studio Guidance &gt; </Link>
