...
const initialState = {
  skills: [],
  journalEntries: [],
  certificationOneStatus: null,
  certificationTwoStatus: null,
  student: null,
  loading: true
}
...
function IamrProvider({ children }) {
  ...
  const value = useMemo(() => {
    return {
      skills: state.skills,
      certificationOneStatus: state.certificationOneStatus,
      certificationTwoStatus: state.certificationTwoStatus,
