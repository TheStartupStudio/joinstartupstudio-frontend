...
import AddIndividual from '../../MyStudents/AddStudentsModal/AddIndividual'
import ErrorsModal from '../../MyStudents/AddStudentsModal/ErrorsModal'

const AddStudentsManualyModal = (props) => {
...
export default AddStudentsManualyModal
