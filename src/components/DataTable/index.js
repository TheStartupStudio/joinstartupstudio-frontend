...
const DataTable = ({
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (openMoreActionsDropdown !== null) {
        const moreActionsRef =
          moreActionsDropdownRefs.current[openMoreActionsDropdown]
  ...
  const getMoreActionsOptions = (item) => {
    if (activeTab === 'Organizations') {
      ...
      return [
        ...
        {
          name: isActive ? 'Deactivate Organization' : 'Activate Organization',
      ...
      return [{ name: 'View Feedback', action: 'view-feedback' }]
      ...
      return [
        ...
        // },
        {
          ...
          icon: (
            ...
            >
              <path
                d='M2.5 6.66699V15.0003C2.5 15.442 2.67559 15.8656 2.98816 16.1782C3.30072 16.4907 3.72464 16.6663 4.16667 16.6663H15.8333C16.2754 16.6663 16.6993 16.4907 17.0118 16.1782C17.3244 15.8656 17.5 15.442 17.5 15.0003V6.66699'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
              />
              <path
                d='M18.3337 3.33301H1.66699V6.66634H18.3337V3.33301Z'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
      ...
      return [
        {
          name: isActive ? 'Deactivate Learner' : 'Activate Learner',
          action: isActive ? 'deactivate-learner' : 'activate-learner'
        },
      ...
      return (
        <div className='action-buttons justify-content-between'>
          ...
          >
            ...
            >
              <path
                d='M3.3335 17.7337V2.26699C3.3335 1.93562 3.60213 1.66699 3.9335 1.66699H13.5016C13.6608 1.66699 13.8134 1.73021 13.9259 1.84273L16.4911 4.40792C16.6036 4.52044 16.6668 4.67306 16.6668 4.83219V17.7337C16.6668 18.065 16.3982 18.3337 16.0668 18.3337H3.9335C3.60213 18.3337 3.3335 18.065 3.3335 17.7337Z'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
              />
              <path
                d='M6.6665 8.33301L13.3332 8.33301'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
              ...
              />
              <path
                d='M6.6665 11.667L9.99984 11.667'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
              />
              <path
                d='M13.3335 1.66699V4.40033C13.3335 4.7317 13.6021 5.00033 13.9335 5.00033H16.6668'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
        ...
        <div className='action-buttons'>
          ...
          >
            ...
            >
              ...
              />
              <path
                d='M10 14.1665C8.61929 14.1665 7.5 13.0472 7.5 11.6665C7.5 10.2858 8.61929 9.1665 10 9.1665C11.3807 9.1665 12.5 10.2858 12.5 11.6665C12.5 13.0472 11.3807 14.1665 10 14.1665Z'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
                strokeLinejoin='round'
          ...
          >
            ...
            >
              ...
              />
              <path
                d='M4.16732 6.25033V6.16699C4.16732 5.06242 5.06275 4.16699 6.16732 4.16699H16.334C17.4386 4.16699 18.334 5.06242 18.334 6.16699V13.8337C18.334 14.9382 17.4386 15.8337 16.334 15.8337H6.16732C5.06275 15.8337 4.16732 14.9382 4.16732 13.8337V13.7503'
                stroke='black'
                strokeWidth='1.5'
                strokeLinecap='round'
              />
          ...
          <div
            ...
            ref={(el) => {
              moreActionsDropdownRefs.current[rowKey] = el
            }}
          >
            <button
                    ...
                    const exportPDF = async () => {
                      try {
                        ...
                        if (user?.role_id === 2) {
                          ...
                          const response =
                            await invoiceApi.downloadInvoice(invoiceId)
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d='M15.8337 4.99967V16.6663C15.8337 17.108 15.6581 17.5316 15.3455 17.8441C15.033 18.1567 14.6094 18.3323 14.167 18.3323H5.83366C5.39163 18.3323 4.96807 18.1567 4.65551 17.8441C4.34295 17.5316 4.16699 17.108 4.16699 16.6663V4.99967M6.66699 4.99967V3.33301C6.66699 2.89098 6.84295 2.46742 7.15551 2.15486C7.46807 1.8423 7.89163 1.66634 8.33366 1.66634H11.667C12.109 1.66634 12.5326 1.8423 12.8451 2.15486C13.1577 2.46742 13.3337 2.89098 13.3337 3.33301V4.99967'
                      stroke='black'
                      strokeWidth='1.5'
                      strokeLinecap='round'
                      strokeLinejoin='round'
              ...
              >
                {getMoreActionsOptions(item).map((option, optionIndex) => (
                  <div
                    ...
                    onClick={() =>
                      handleMoreActionOptionClick(option.action, item)
                    }
                  >
                    {option.name}
                  </div>
      ...
      return (
        <div className='action-buttons'>
          ...
          >
            ...
            >
              <path
                d='M3.3335 17.7327V2.26602C3.3335 1.93464 3.60213 1.66602 3.9335 1.66602H13.5016C13.6608 1.66602 13.8134 1.72923 13.9259 1.84175L16.4911 4.40695C16.6036 4.51947 16.6668 4.67208 16.6668 4.83121V17.7327C16.6668 18.0641 16.3982 18.3327 16.0668 18.3327H3.9335C3.60213 18.3327 3.3335 18.0641 3.3335 17.7327Z'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
              />
              <path
                d='M6.6665 8.33398L13.3332 8.33399'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
              ...
              />
              <path
                d='M6.6665 11.666L9.99984 11.666'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
              />
              <path
                d='M13.3335 1.66602V4.39935C13.3335 4.73072 13.6021 4.99935 13.9335 4.99935H16.6668'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
          ...
          >
            ...
            >
              <path
                d='M16.6668 9.99935V4.83121C16.6668 4.67208 16.6036 4.51947 16.4911 4.40695L13.9259 1.84175C13.8134 1.72923 13.6608 1.66602 13.5016 1.66602H3.9335C3.60213 1.66602 3.3335 1.93464 3.3335 2.26602V17.7327C3.3335 18.0641 3.60213 18.3327 3.9335 18.3327H9.16683'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
              />
              <path
                d='M6.6665 8.33333H13.3332M6.6665 5H9.99984M6.6665 11.6667H9.1665'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
              />
              <path
                d='M14.9618 14.1159L15.7951 13.2826C16.16 12.9177 16.7517 12.9177 17.1166 13.2826C17.4815 13.6475 17.4815 14.2392 17.1166 14.6041L16.2833 15.4374M14.9618 14.1159L12.5077 16.5701C12.3578 16.72 12.2594 16.9136 12.2267 17.1231L12.0328 18.3664L13.276 18.1726C13.4855 18.1399 13.6792 18.0415 13.8291 17.8916L16.2833 15.4374M14.9618 14.1159L16.2833 15.4374'
                stroke='black'
                stroke-width='1.5'
                stroke-linecap='round'
                stroke-linejoin='round'
          ...
          >
            {item.status === 'published' ? (
              ...
              >
                <path
                  d='M16.1261 17.5007H3.87356C2.33553 17.5007 1.37308 15.837 2.13974 14.5037L8.26603 3.84931C9.03504 2.5119 10.9646 2.5119 11.7336 3.84931L17.8599 14.5037C18.6266 15.837 17.6642 17.5007 16.1261 17.5007Z'
                  stroke='black'
                  stroke-width='1.5'
                  stroke-linecap='round'
                />
  ...
  const handleFilterClick = (columnKey, columnIndex, event) => {
    ...
    setOpenFilterDropdown(
      openFilterDropdown === dropdownKey ? null : dropdownKey
    )
    setOpenMoreActionsDropdown(null)
  }
          ...
          <div className='date-input-group' style={{ flex: 1 }}>
            ...
            >
              <DatePicker
                ...
                onChange={(date) =>
                  handleDateFilterChange(columnKey, 'from', date)
                }
              ...
              {currentFilter.from && (
                <button
                  ...
                  onClick={() =>
                    handleDateFilterChange(columnKey, 'from', null)
                  }
                  style={{
                    position: 'absolute',
                    right: '10px',
          ...
          <div className='date-input-group' style={{ flex: 1 }}>
            ...
            >
              <DatePicker
                ...
                onChange={(date) =>
                  handleDateFilterChange(columnKey, 'to', date)
                }
                placeholderText='Choose Date'
                dateFormat='MM/dd/yyyy'
                className='date-input'
                ...
                <div className='header-with-icons'>
                  ...
                  {column.filterable && (
                    <div
                      ...
                      style={{ position: 'relative' }}
                      ref={(el) =>
                        (filterDropdownRefs.current[`${column.key}-${index}`] =
                          el)
                      }
                    >
                      <img
          ...
          {loading && !loadingTimeout ? (
            ...
            filteredData.map((item, index) => (
              ...
              >
                ...
                <td className='actions-column'>{renderActions(item, index)}</td>
              </tr>
            ))
          )}
        </tbody>
