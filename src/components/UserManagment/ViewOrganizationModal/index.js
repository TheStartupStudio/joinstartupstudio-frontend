...
const ViewOrganizationModal = ({ show, onHide, organizationData, onSave }) => {
  ...
  useEffect(() => {
    if (organizationData) {
      setFormData({
        name: organizationData.name || 'Nord Anglia Schools',
        address: organizationData.address || '2108 S Conroy-Windermere Rd, Orlando, FL 34708',
        adminName: organizationData.adminName || 'Angela Nguyen',
        adminEmail: organizationData.adminEmail || 'anguyen@ordanglia.com',
        domain: organizationData.domain || 'nordanglia.aie.com',
      ...
      <Modal.Body className="view-org-modal-body">
        ...
        <div className="org-section">
          ...
          <div className="org-logos">
            <img 
              src={formData.logo1 || 'https://via.placeholder.com/120'} 
              alt="Organization Logo 1" 
              className="org-logo"
            />
            <img 
              src={formData.logo2 || 'https://via.placeholder.com/200x50'} 
        ...
        {/* Pricing Details Section - Enhanced for Edit Mode */}
