        ...
        <div className="course-progress-section">
          <div className="section-header-view-progress">
            ...
            <button className="view-details-link" onClick={handleViewDetails}>
              View Details
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M5.00033 10H15.417M15.417 10L10.417 5M15.417 10L10.417 15" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </button>
          </div>
