...
const ViewInvoiceModal = ({ show = true, onHide, onSuccess, invoiceData = null }) => {
    ...
    >
      <div className="invoice-modal-content">
        ...
        <div className="invoice-modal-header">
          ...
          <h4 className="invoice-modal-title">View Invoice</h4>
        ...
        <div className="invoice-modal-body">
          ...
          <div className="invoice-items-section">
            ...
            <div className="invoice-item-row add-item-row" style={{ padding: '0px 42px 20px 30px' }}>
              ...
              <div className="item-cell total-col">
                <span className="item-total">$10,000</span>
