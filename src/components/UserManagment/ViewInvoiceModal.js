...
const ViewInvoiceModal = ({
  ...
  const handleEditingItemChange = (field, value) => {
    ...
    if (field === 'quantity' || field === 'price') {
      const qty =
        parseFloat(field === 'quantity' ? value : editingItemData.quantity) || 0
      const price =
        parseFloat(field === 'price' ? value : editingItemData.price) || 0
  ...
  const handleNewItemChange = (field, value) => {
    ...
    if (field === 'quantity' || field === 'price') {
      const qty =
        parseFloat(field === 'quantity' ? value : newItemData.quantity) || 0
      const price =
        parseFloat(field === 'price' ? value : newItemData.price) || 0
      updatedItem.total = qty * price
    }
          ...
          <div className='invoice-modal-header'>
            <div className='modal-icon'>
              ...
              >
                ...
                />
                <path
                  d='M6.66667 12.5V3.1C6.66667 2.76863 6.93529 2.5 7.26667 2.5H16.9C17.2314 2.5 17.5 2.76863 17.5 3.1V14.1667C17.5 16.0076 16.0076 17.5 14.1667 17.5'
                  stroke='black'
                  strokeWidth='1.5'
                  strokeLinecap='round'
                  strokeLinejoin='round'
                />
                <path
                  d='M4.49935 12.5H6.66602H10.2327C10.5641 12.5 10.8359 12.7682 10.8662 13.0982C10.9879 14.4253 11.5521 17.5 14.166 17.5H6.66602H5.49935C3.84249 17.5 2.49935 16.1569 2.49935 14.5C2.49935 13.3954 3.39478 12.5 4.49935 12.5Z'
                  stroke='black'
                  strokeWidth='1.5'
                  strokeLinecap='round'
                  strokeLinejoin='round'
              ...
              {mode === 'view' && !loading ? (
                <>
                  ...
                  >
                    ...
                    >
                      <path
                        d='M26.25 18.75V23.125C26.25 23.6223 26.0525 24.099 25.7008 24.4508C25.349 24.8025 24.8723 25 24.375 25H5.625C5.12772 25 4.65081 24.8025 4.29917 24.4508C3.94754 24.099 3.75 23.6223 3.75 23.125V18.75'
                        stroke='black'
                        strokeWidth='1.5'
                        strokeLinecap='round'
                        strokeLinejoin='round'
                  ...
                  {!isInstructor && (
                    <>
                      ...
                      >
                        ...
                        >
                          <path
                            d='M11.25 11.25L16.875 15L22.5 11.25'
                            stroke='black'
                            strokeWidth='1.5'
                            strokeLinecap='round'
                            strokeLinejoin='round'
                          ...
                          />
                          <path
                            d='M6.25 9.375V8.25C6.25 7.14543 7.14543 6.25 8.25 6.25H25.5C26.6046 6.25 27.5 7.14543 27.5 8.25V21.75C27.5 22.8546 26.6046 23.75 25.5 23.75H8.25C7.14543 23.75 6.25 22.8546 6.25 21.75V20.625'
                            stroke='black'
                            strokeWidth='1.5'
                            strokeLinecap='round'
                          />
                ...
                >
                  ...
                  >
                    <path
                      d='M3.75 24.25V5.75C3.75 4.64543 4.64543 3.75 5.75 3.75H20.4216C20.952 3.75 21.4607 3.96071 21.8358 4.33579L25.6642 8.16421C26.0393 8.53929 26.25 9.04799 26.25 9.57843V24.25C26.25 25.3546 25.3546 26.25 24.25 26.25H5.75C4.64543 26.25 3.75 25.3546 3.75 24.25Z'
                      stroke='black'
                      strokeWidth='1.5'
                    />
                    <path
                      d='M10.6 11.25H19.4C19.7314 11.25 20 10.9814 20 10.65V4.35C20 4.01863 19.7314 3.75 19.4 3.75H10.6C10.2686 3.75 10 4.01863 10 4.35V10.65C10 10.9814 10.2686 11.25 10.6 11.25Z'
                      stroke='black'
                      strokeWidth='1.5'
                    />
                    <path
                      d='M7.5 16.85V26.25H22.5V16.85C22.5 16.5186 22.2314 16.25 21.9 16.25H8.1C7.76863 16.25 7.5 16.5186 7.5 16.85Z'
                      stroke='black'
                      strokeWidth='1.5'
                    />
                  </svg>
            ...
            <div className='instructor-payment-info'>
              <span className='payment-info-text'>
                {formData.status === 'scheduled' ? (
                  <>
                    Invoice will be automatically paid on{' '}
                    {formData.dueDate || 'N/A'}
                  </>
                ) : formData.status === 'paid' ? (
                  <>
                    Invoice was successfully paid on{' '}
                    {formData.paidDate || formData.dueDate || 'N/A'}
                  </>
                  ...
                  <>
                    Invoice overdue - Payment was due on{' '}
                    {formData.dueDate || 'N/A'}
                  </>
              ...
              <div className='edit-payment-btn' onClick={handlePayInvoice}>
                ...
                >
                  <path
                    d='M11.333 2.00004C11.5081 1.82494 11.7169 1.68605 11.9457 1.59129C12.1745 1.49653 12.4191 1.44775 12.6663 1.44775C12.9135 1.44775 13.1581 1.49653 13.3869 1.59129C13.6157 1.68605 13.8245 1.82494 13.9997 2.00004C14.1748 2.17513 14.3137 2.38393 14.4084 2.61272C14.5032 2.84151 14.552 3.08615 14.552 3.33337C14.552 3.58059 14.5032 3.82524 14.4084 4.05403C14.3137 4.28282 14.1748 4.49161 13.9997 4.66671L5.33301 13.3334L1.33301 14.6667L2.66634 10.6667L11.333 2.00004Z'
                    stroke='#51C7DF'
                    strokeWidth='1.5'
                    strokeLinecap='round'
                    strokeLinejoin='round'
          ...
          <div className='invoice-modal-body' ref={invoiceContentRef}>
            ...
            <div className='invoice-top-section'>
              <div className='issued-to-section'>
                ...
                <label className='address-section-label'>
            ...
            <div className='invoice-items-section'>
                    ...
                    <>
                      ...
                      <div className='item-cell qty-col'>
                        <input
                          ...
                          onChange={(e) =>
                            handleEditingItemChange('quantity', e.target.value)
                          }
                        />
                      </div>
                      <div className='item-cell price-col'>
                        <input
                          ...
                          onChange={(e) =>
                            handleEditingItemChange('price', e.target.value)
                          }
                        />
                      </div>
                      <div className='item-cell total-col'>
                        <span className='item-total'>
                          ${editingItemData.total?.toLocaleString()}
                        </span>
                        <button
              ...
              {mode === 'edit' && (
                <div
                  className='invoice-item-row add-item-row'
                  style={{ padding: '0px 42px 20px 30px' }}
                >
                  <div className='item-cell description-col'>
                    <input
                      type='text'
                  ...
                  <div className='item-cell total-col'>
                    <span className='item-total'>
                      ${newItemData.total?.toLocaleString()}
                    </span>
                    <button
                      className='confirm-btn'
