...
const SIDEBAR_MENU_ITEMS = [
  ...
  },
  {
    ...
    roles: [3, 2],
    className: (pathname) =>
      pathname.includes('user-managment') ? 'active' : ''
  },
  {
    ...
    roles: [3],
    className: (pathname) =>
      pathname.includes('content-management') ? 'active' : ''
  },
  {
  ...
  // },
  {
    ...
    roles: [3],
    className: (pathname) =>
      pathname.includes('manage-content-site') ? 'active' : ''
  },
  {
    id: 'intro-course',
  ...
  },
  {
    ...
    roles: [2, 1],
    className: (pathname) =>
      pathname.includes('my-course-in-entrepreneurship/journal') ? 'active' : ''
  },
  {
    id: 'master-classes',
    ...
    requiresUniversitySetting: 'hasMasterClasses',
    className: (pathname) =>
      pathname.includes('beyond-your-course') ? 'active' : ''
  },
  // {
  ...
  },
  {
    ...
    roles: [3, 2],
    className: (pathname) =>
      pathname.includes('view-invoices') ? 'active' : ''
  }
]
...
const InstructorSidebar = (props) => {
    ...
    const iconOptions = [
      {
        ...
        svg: (
          ...
          >
            <path
              d='M14.5 2H4.5C4.23478 2 3.98043 2.10536 3.79289 2.29289C3.60536 2.48043 3.5 2.73478 3.5 3V21C3.5 21.2652 3.60536 21.5196 3.79289 21.7071C3.98043 21.8946 4.23478 22 4.5 22H18.5C18.7652 22 19.0196 21.8946 19.2071 21.7071C19.3946 21.5196 19.5 21.2652 19.5 21V10.0025'
              stroke='black'
              stroke-width='2'
            ...
            />
            <path
              d='M6.5 9H10.5M6.5 14H12.5'
              stroke='black'
              stroke-width='2'
              stroke-linecap='round'
            />
            <path
              d='M20.5 3L14.5015 8.9975'
              stroke='black'
              stroke-width='2'
              stroke-linecap='round'
              stroke-linejoin='round'
      ...
      },
      {
        ...
        svg: (
          ...
          >
            <path
              d='M16 22.25v-2.582l2.334 0.394a1.5 1.5 0 0 0 1.744 -1.353l0.287 -3.406c0.925 -0.207 1.59 -0.541 2.021 -0.821 0.387 -0.251 0.432 -0.755 0.174 -1.137L20.488 10.275c-0.246 -4.613 -4.064 -8.276 -8.738 -8.276v20.25'
              stroke='black'
              strokeWidth='1.5'
              strokeLinecap='round'
            ...
            />
            <path
              d='M1.5 12a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0 -3 0ZM4 4.5a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0 -3 0Zm-0.5 15.5a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0 -3 0Z'
              stroke='black'
              strokeWidth='1.5'
            />
            <path
              d='M4.5 12h7.25m0 -4H9l-2.25 -2.25m5 10.75h-3.25l-2.25 2.25'
              stroke='black'
              strokeWidth='1.5'
              strokeLinecap='round'
              strokeLinejoin='round'
      ...
      },
      {
        ...
        svg: (
          ...
          >
            <path
              d='M16.4 21h-2.154l-2 -5H5.754L3.755 21H1.6l6.4 -16h2zM21 12v9h-1.999V12zM6.555 14h4.892L9 7.885zm12.975 -11.68a0.508 0.508 0 0 1 0.941 0l0.253 0.61a4.373 4.373 0 0 0 2.25 2.327l0.717 0.32a0.529 0.529 0 0 1 0 0.962l-0.758 0.338a4.35 4.35 0 0 0 -2.22 2.25l-0.246 0.566a0.506 0.506 0 0 1 -0.934 0l-0.247 -0.565a4.35 4.35 0 0 0 -2.219 -2.251l-0.76 -0.338a0.53 0.53 0 0 1 0 -0.964l0.718 -0.32a4.373 4.373 0 0 0 2.25 -2.325z'
              fill='black'
            />
          </svg>
        )
      },
      {
        ...
        svg: (
          ...
          >
            <path
              d='M4.688 21.094a0.792 0.792 0 0 1 -0.781 -0.781v-15.625a0.781 0.781 0 0 1 1.563 0v15.625a0.792 0.792 0 0 1 -0.781 0.781'
              fill='black'
            />
            <path
              d='M20.313 21.094h-15.625a0.781 0.781 0 1 1 0 -1.563h15.625a0.781 0.781 0 0 1 0 1.563m-5.729 -5.729a0.771 0.771 0 0 1 -0.552 -0.229L11.458 12.563l-2.573 2.573a0.781 0.781 0 0 1 -1.104 -1.104l3.125 -3.125a0.781 0.781 0 0 1 1.104 0L14.583 13.479l3.615 -3.615a0.781 0.781 0 0 1 1.104 1.104l-4.167 4.167a0.771 0.771 0 0 1 -0.551 0.229'
              fill='black'
            />
            <path
              d='M19.271 14.417a0.792 0.792 0 0 1 -0.781 -0.781v-2.958H15.625a0.781 0.781 0 1 1 0 -1.563h3.646a0.792 0.792 0 0 1 0.781 0.781v3.74a0.792 0.792 0 0 1 -0.781 0.781'
              fill='black'
            />
          </svg>
        )
      },
      {
        ...
        svg: (
          ...
          >
            <path
              d='M22 3H2A2.075 2.075 0 0 0 0 5v14c0.04 1.091 0.91 1.96 24 0 -0.018 -14.524 -0.235 -15.023 -0.606 -15.394A2.078 2.078 0 0 0 22 3m0 16H2V5h20zm-8 -1.999V15.75c0 -1.66 -3.34 -2.5 -5 -2.5S4 14.09 4 15.75v1.25zM9 7A2.5 2.5 0 1 0 9 12a2.5 2.5 0 0 0 0 -5m5 0v1.001h6V7zm0 2v1h6V9zm0 2V12H18v-1z'
              fill='black'
            />
          </svg>
        )
      },
      {
        ...
        svg: (
          ...
          >
            <path
              d='M20 4H4A1.984 1.984 0 0 0 2.01 6.001l-0.01 12a1.993 1.993 0 0 0 2 1.999h16a1.993 1.993 0 0 0 2 -1.999V6a1.993 1.993 0 0 0 -2 -2m0 14H4v-6h16zm0 -10H4V6.001h16z'
              fill='black'
            />
          </svg>
        )
    ...
    const fetchManageContent = async () => {
      try {
        ...
        const response = await axiosInstance.get(
          '/journal-courses/manage-content/all'
        )
  ...
  const handleMenuItemClick = (item) => {
    if (item.id === 'forum') {
      const isSubscribed =
        user?.stripe_subscription_id || user?.subscription_exempt
