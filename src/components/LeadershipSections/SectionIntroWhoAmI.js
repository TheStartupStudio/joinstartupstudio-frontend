    ...
    <div className='leadership-layout d-grid gap-5 grid-col-1-mob'>
      <div className='w-100'>
        <YourInstructor
          ...
          videoUrl={journalData?.videoId ? `https://d5tx03iw7t69i.cloudfront.net/Journal/LeadershipJournal/LJ 2 Section One Who Am I - V2.mov` : 'https://d5tx03iw7t69i.cloudfront.net/Journal/LeadershipJournal/LJ 2 Section One Who Am I - V2.mov'}
          thumbnailUrl={manageContentData?.videoThumbnail || "https://demo-startupstudio-drive.s3.amazonaws.com/users/1972/02fd00cdd211ff6a9d1cef183f6982b0-1747040727899.jpg"}
       ...
       <NotesButton from="leadershipJournal"
                    data={{
                      id: journalData?.id || 1001062,
                      title: journalData?.title || 'Introduction to Who am I?'
                    }}
                    createdFrom={journalData?.title || 'Introduction to Who am I?'}
                    journalId={journalData?.id || 1001062}
              />
      <SectionsWrapper
        title={journalData?.title || 'Introduction to Who am I?'}
