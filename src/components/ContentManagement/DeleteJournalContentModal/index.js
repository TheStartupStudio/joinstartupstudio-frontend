  ...
  return (
    <>
      <div className='delete-journal-content-modal-overlay' onClick={onClose}>
        <div
          className='delete-journal-content-modal'
        ...
        >
          ...
          <div className='modal-body'>
            ...
            <p className='modal-message' style={{ marginTop: '20px' }}>
              {!isArchived ? (
                <p>
                  Note: Deleting the content will not delete any tasks. All
                  tasks will be unpublished and no longer be accessible to
                  learners. You can find unassigned tasks in the Archive.
                </p>
              ) : (
                <p>
                  Note: Deleting this task will also delete all learner
            ...
            >
              <input type='checkbox' />
              <p className='modal-message'>Also delete associated tasks.</p>
            </div>
          </div>
          ...
          <div className='modal-actions'>
            ...
            <div
              className={`d-flex gap-2 ${isArchived ? 'w-100 justify-content-center' : 'w-100'}`}
            >
              <div onClick={onClose}>
